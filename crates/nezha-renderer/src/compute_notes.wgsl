...
@group(0) @binding(2) var<storage> key_offsets: array<u32, 128>;
@group(0) @binding(3) var<storage> key_counts: array<u32, 128>;
@group(0) @binding(4) var<storage> notes: array<GpuNote>;
@group(0) @binding(5) var<storage> palette: array<vec4<f32>, 128>;
@group(0) @binding(6) var<storage, read_write> instances: array<NoteInstance>;
@group(0) @binding(7) var<storage, read_write> instance_count: atomic<u32>;
@group(0) @binding(8) var<storage> key_scans: array<u32, 128>;
